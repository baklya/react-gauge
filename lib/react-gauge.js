...
var ReactGauge = React.createClass({
  ...
  render: function () {
    ...
    var Gauge = function(selector, ranges, marks, arrowValue){
    ...
    return (
        ...
        React.createElement('svg', {className: "commentBox"},
            React.createElement('circle', {cx: "50", cy: "50", r: "50", fill: "red", })
